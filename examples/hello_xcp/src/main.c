...
// A global calibration segment index (handle for the calibration parameter segment for `params`).
// The calibration parameter segment can be shared and accessed lock-less in in multiple threads.
