...
#if defined(__ELF__)
#define XCP_EVENT_SECTION_ATTR __attribute__((section("xcp_events"), used))
...
/// The descriptor is placed in the xcp_events section so XcpInit() pre-registers the event.
